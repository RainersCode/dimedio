...
export default function DrugDispensingOrganizationSelector({ onError, onSuccess }: OrganizationSelectorProps) {
  const {
    activeMode,
    membershipStatus,
    allOrganizations,
  ...
  return (
    <div className="bg-white border border-slate-200 rounded-xl p-6">
      <div className="mb-4">
        <h3 className="text-lg font-semibold text-slate-900 mb-2">Drug Dispensing View</h3>
        <p className="text-sm text-slate-600">Switch between different dispensing histories to view individual practice or organization team drug dispensing records.</p>
      </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              }`}>Individual Dispensing</div>
              <div className={`text-sm ${
                activeMode === 'individual' ? 'text-blue-700' : 'text-slate-600'
              }`}>Your personal dispensing records</div>
            </div>
            {activeMode === 'individual' && (
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className={`text-sm ${
                  ...
                  {org.role === 'admin' ? 'Administrator' : 'Member'} • Organization dispensing
                </div>
              </div>
      ...
      {switching && (
        <div className="mt-4 flex items-center justify-center py-2">
          ...
          <span className="text-sm text-slate-600">Switching dispensing view...</span>
        </div>
      )}
    </div>
  );
